<div class="p-10 grid text-base">
    ...
    <div class="overflow-x-auto">
        <table class=" my-5 mx-auto w-full rounded-md shadow-md bg-white text-sm">
                <tr >
                    <td class="flex justify-between gap-5 pt-5 px-3 align-middle border-2">
                        ...
                        <div class="flex items-end">
                            <label for="tab1" class="tab-label font-semibold text-gray-500 px-4 py-2 cursor-pointer {{ $statusid === '1' ? 'border-t-2 border-x-2 border-t-[#818cf8] rounded-t-lg text-gray-800  bg-white -mb-1 ' : '' }} transition-colors duration-300">Belum Divalidasi</label>
                            <label for="tab2" class="tab-label font-semibold text-gray-500 px-4 py-2 cursor-pointer {{ $statusid === '3' ? 'border-t-2 border-x-2 border-t-[#818cf8] rounded-t-lg text-gray-800 bg-white -mb-1' : '' }} transition-colors duration-300">Diterima</label>
                            <label for="tab3" class="tab-label font-semibold text-gray-500 px-4 py-2 cursor-pointer {{ $statusid === '4' ? 'border-t-2 border-x-2 border-t-[#818cf8] rounded-t-lg text-gray-800 bg-white -mb-1' : '' }} transition-colors duration-300">Ditolak</label>
                            <label for="tab4" class="tab-label font-semibold text-gray-500 px-4 py-2 cursor-pointer {{ $statusid === '0' ? 'border-t-2 border-x-2 border-t-[#818cf8] rounded-t-lg text-gray-800 bg-white -mb-1' : '' }} transition-colors duration-300">Semua</label>
                        </div>    
                            ...
                            <div class=" flex min-w-fit mb-3 gap-5">
                                    ...
                                    <button wire:click="exportData({{$statusid}})" class="bg-[#43a047] w-fit px-4 py-2 text-white justify-self-end rounded-lg shadow-md">Export</button>
